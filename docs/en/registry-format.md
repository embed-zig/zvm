...
- `0.15.2-esp.r5` (r5 release for 0.15.2)
- `0.16.0-esp.r2` (r2 release for 0.16.0)
...
| -------------- | ------------------------- | ------------------------- |
| `0.15.2`       | Exact                     | `0.15.2`                  |
| `0.15.2-esp.`* | All ESP builds for 0.15.2 | `0.15.2-esp.r5` (highest) |
